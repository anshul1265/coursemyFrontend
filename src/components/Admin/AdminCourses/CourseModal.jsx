...
const CourseModal = ({ isOpen, onClose, id, addLectureHandler, deleteButtonHandler, courseTitle, lectures = [], loading }) => {
            ...
            <Box>
              ...
              <form onSubmit={e => addLectureHandler(e, id, title, description, video)}>
                ...
                <VStack spacing={'4'}>
                  ...
                  <Button w='full' type='submit' isLoading={loading} colorScheme='purple'>Upload</Button>
                </VStack>
  ...
  return (
    <Stack direction={['column', 'row']} my={'8'} borderRadius={'lg'} boxShadow={'0 0 10px rgba(107,70,193,0.5)'} justifyContent={['flex-start', 'space-between']} p={['4', '8']}>
      ...
      <Button isLoading={loading}>
        <RiDeleteBin7Fill color='purple.600' onClick={() => deleteButtonHandler(courseId, lectureId)} />
      </Button>
